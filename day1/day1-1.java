...
public class AdventOfCode {
	public static void main(String[] args) {
		...
		// iterate over both lists at same time and find the difference between each set and add to sum
		for(Integer i=0;i<firstList.size();i++) {
			totalSum += Math.abs(firstList.get(i) - secondList.get(i));
		}

		// spit out the sum of the differences for answer
		System.out.println("Answer for Day 1 Star 1: " + totalSum);
	}
}
